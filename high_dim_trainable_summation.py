...
def main():
    ...
    model_concat = tf.keras.layers.Dense(1, activation='linear', use_bias=False)(model_concat)
    ...
    f = open('accuracy_trainable_summation_8x8_4qubits_mnist_' + str(datapoints) + 'datapoints.txt', 'a+')
